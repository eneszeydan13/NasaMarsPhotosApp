...
import com.example.nasaproject.service.SpiritNetwork
...
class SpiritFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        spiritRecyclerView.adapter = adapter
        loadSpiritPhotos()
    }

    private fun loadSpiritPhotos(){

        val call = SpiritNetwork.retrofit.getSpiritPhotos()
